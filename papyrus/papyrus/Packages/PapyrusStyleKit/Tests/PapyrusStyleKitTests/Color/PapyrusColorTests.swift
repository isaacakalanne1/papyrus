...
class PapyrusColorTests {
    ...
    func papyrusColor_colorComponents(colorCase: PapyrusColor, expectedRed: Double, expectedGreen: Double, expectedBlue: Double) {
        ...
        let color = colorCase.color(in: scheme)
    ...
    func papyrusColor_borderAndButtonGradientBottomConsistency() {
        ...
        let borderColor = PapyrusColor.borderPrimary.color(in: scheme)
        let buttonBottomColor = PapyrusColor.buttonGradientBottom.color(in: scheme)
    ...
    func papyrusColor_backgroundColors() {
        ...
        #expect(backgroundColor.color(in: scheme) != Color.clear)
        #expect(backgroundSecondaryColor.color(in: scheme) != Color.clear)
    ...
    func papyrusColor_textColors() {
        ...
        // Both should return valid colors
        #expect(textPrimary.color(in: scheme) != Color.clear)
        #expect(textSecondary.color(in: scheme) != Color.clear)
    ...
    func papyrusColor_colorPropertyConsistency() {
        ...
        let color1 = testColor.color(in: scheme)
        let color2 = testColor.color(in: scheme)
        let color3 = testColor.color(in: scheme)
    ...
    @Test
    func papyrusColorScheme_allCasesHaveSchemes() {
        for name in PapyrusColorSchemeName.allCases {
            let scheme = name.scheme
            // Verify scheme has valid (non-clear) colors
            #expect(scheme.background != Color.clear)
            #expect(scheme.textPrimary != Color.clear)
            #expect(scheme.accent != Color.clear)
        }
    }

    @Test
    func papyrusColorSchemeName_displayNamesAreNonEmpty() {
        for name in PapyrusColorSchemeName.allCases {
